...
$sql = "UPDATE results SET resday = '".$resday."', resmonth = '".$resmonth."', resyear = '".$resyear."', organisation = '".$organisation."', showname = '".$showname."' , showclass = '".$showclass."' , result = '".$result."'  WHERE id = ".$resid.";";
