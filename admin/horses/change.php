...
<div class="horseimagechange">
	...
	<?php
			...
			$sql ="SELECT * FROM ".$tablename." WHERE stamp= ".$stamp." ORDER BY id ASC";
					...
					{
						?>
<form name="mainimageupdate" enctype="multipart/form-data" action="?action=member&amp;process=mainimageupdate" method="post">
<?php
					//here is the loop using the statement above
					while($info = mysql_fetch_array( $data ))
						{
...
?>
	<div class="horseimage">
		...
		<div class="small">
		<a href="?action=member&amp;process=horseimagedeletecheck&amp;stamp=<?php echo $stamp ; ?>&amp;imageid=<?php echo $image_id ; ?>">
			<img src="images/delete.gif" alt="<?php echo $ADM['deleteinfo']; ?>" title="<?php echo $ADM['deleteinfo']; ?>" />
		</a>
        Delete
		</div>
...
<table>
    ...
    <tr>
        <td >
            &nbsp;
<a href="?action=member&amp;process=horseinfoupdate&amp;stamp=<?php echo $stamp  ?>&amp;id=<?php echo $id  ?>&amp;type=<?php echo $file  ?>">
<img src="images/edit.gif" alt="<?php echo $ADM['changeinfo']; ?>" title="<?php echo $ADM['changeinfo']; ?>" />
      	</a>
      	</td>
    </tr>
    <tr>
    	<td >
            &nbsp;
<a href="?action=member&amp;process=horseinfodeletecheck&amp;stamp=<?php echo $stamp  ?>&amp;id=<?php echo $id  ?>&amp;type=<?php echo $file  ?>">
      			<img src="images/delete.gif" alt="<?php echo $ADM['deleteinfo']; ?>" title="<?php echo $ADM['deleteinfo']; ?>" />
      	</a>
      	</td>
    </tr>
...
?>
<div class="full">
<form name="addnewinfo" enctype="multipart/form-data" action="?action=member&amp;process=horseinfoadd" method="post">
<table>
	<tr>
    	<td>
        	<input name="stamp" type="hidden" value="<?php echo $stamp ; ?>" />
            <input name="submit" type="submit" value="Add extra info" />
        </td>
    </tr>
</table>
</form>
...
<form name="results" enctype="multipart/form-data" action="?action=member&amp;process=results" method="post">   
    <table>
    	<tr>
        	<td>
